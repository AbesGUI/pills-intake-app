...
<html lang="en">
    ...
    <form class="pt-3" action="<?php echo base_url('/renew-password/'); ?>" method="post">
            ...
            <div class="card px-1 py-4">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label for="code">Code</label> <input name="code" class="form-control"
                                                                      type="number"
                                                                      placeholder="ex. 50235"></div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class=" d-flex flex-column text-center px-5 mt-3 mb-3">
                        <button class="btn btn-primary btn-block confirm-button">Change Password</button>
                    </div>
                </div>
            </div>
        </div>
