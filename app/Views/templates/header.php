    ...
    <div class="container-fluid">
        ...
        <div class=" collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav mx-auto ">
                <li class="nav-item">
                    <a class="nav-link mx-2 btn-outline-primary <?php if(current_url() == base_url('/index.php/profile')) { echo 'active';} ?>" aria-current="page" href="<?php echo base_url();?>/profile">Profile</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link mx-2 btn-outline-primary <?php if(current_url() == base_url('/index.php/drugs')) { echo 'active';} ?>" href="<?php echo base_url();?>/drugs">Drug List</a>
                </li>
        ...
        <?php else: ?>
            <div class=" collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav mx-auto ">
                    <li class="nav-item">
                        <a class="nav-link mx-2 btn-outline-primary <?php if(current_url() == base_url('/index.php/drugs')) { echo 'active';} ?>" href="<?php echo base_url();?>/signin">Signin</a>
                    </li>
                    <li class="nav-item d-none d-lg-block">
