...
<link rel="stylesheet" type="text/css" href="<?= base_url(); ?>/styles/templates.css">
<nav class="navbar navbar-expand-lg navbar-dark p-3 btn-lg" id="headerNav">
    <div class="container-fluid">
        <a class="navbar-brand d-block d-lg-none" href="#">
            <img src="<?= base_url('/images/pills.png') ?>" height="80"/>
        </a>
                ...
                <ul class="navbar-nav mx-auto ">
                    <li class="nav-item">
                        <a class="nav-link mx-2 btn-outline-primary <?php if (current_url() == base_url('/index.php/profile')) {
                            echo 'active';
                        } ?>" aria-current="page" href="<?= base_url(); ?>/profile">Profile</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link mx-2 btn-outline-primary <?php if (current_url() == base_url('/index.php/drugs')) {
                            echo 'active';
                        } ?>" href="<?= base_url(); ?>/drugs">Drug List</a>
                    </li>
                    <li class="nav-item d-none d-lg-block">
                        <a class="nav-link mx-2" href="<?= base_url(); ?>/profile">
                            <img src="<?= base_url('/images/pills.png') ?>" width="120px"/>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link mx-2 btn-outline-primary" href="<?= base_url(); ?>/signout">Logout</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link mx-2 btn-outline-primary <?php if (current_url() == base_url('/index.php/schedule')) {
                            echo 'active';
                        } ?>" href="<?= base_url(); ?>/schedule">New schedule</a>
                    </li>
                </ul>
            </div>
        <?php else: ?>
